...
F 2 "LED_THT:LED_D1.8mm_W3.3mm_H2.4mm" H 8400 3800 50  0001 C CNN
...
U 1 1 5D75D30A
P 4700 2100
F 0 "#PWR04" H 4700 1850 50  0001 C CNN
...
U 1 1 5D82EF91
P 9500 3650
F 0 "#PWR07" H 9500 3500 50  0001 C CNN
F 1 "+9V" H 9515 3823 50  0000 C CNN
...
F 2 "LED_THT:LED_D1.8mm_W3.3mm_H2.4mm" H 8000 3800 50  0001 C CNN
...
U 1 1 5D8894FB
P 10550 2750
F 0 "J1" H 10522 2632 50  0000 R CNN
F 1 "IN_OUT" H 10522 2723 50  0000 R CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x02_P2.54mm_Vertical" H 10550 2750 50  0001 C CNN
F 3 "~" H 10550 2750 50  0001 C CNN
	1    10550 2750
	-1   0    0    1   
$EndComp
$Comp
L Timer:LMC555xMM U1
U 1 1 5D98DFF0
P 5250 4400
F 0 "U1" H 5350 4750 60  0000 C CNN
F 1 "NE555DR" H 5250 4400 60  0000 C CNN
F 2 "Package_SO:VSSOP-8_3.0x3.0mm_P0.65mm" H 5450 4600 60  0001 L CNN
F 3 "http://www.ti.com/lit/ds/symlink/ne555.pdf" H 5450 4700 60  0001 L CNN
F 4 "296-6501-1-ND" H 5450 4800 60  0001 L CNN "Digi-Key_PN"
F 5 "NE555DR" H 5450 4900 60  0001 L CNN "MPN"
F 6 "Integrated Circuits (ICs)" H 5450 5000 60  0001 L CNN "Category"
F 7 "Clock/Timing - Programmable Timers and Oscillators" H 5450 5100 60  0001 L CNN "Family"
F 8 "http://www.ti.com/lit/ds/symlink/ne555.pdf" H 5450 5200 60  0001 L CNN "DK_Datasheet_Link"
F 9 "/product-detail/en/texas-instruments/NE555DR/296-6501-1-ND/372490" H 5450 5300 60  0001 L CNN "DK_Detail_Page"
F 10 "IC OSC SGL TIMER 100KHZ 8-SOIC" H 5450 5400 60  0001 L CNN "Description"
F 11 "Texas Instruments" H 5450 5500 60  0001 L CNN "Manufacturer"
F 12 "Active" H 5450 5600 60  0001 L CNN "Status"
	1    5250 4400
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5DD0CB86
P 10550 2450
F 0 "J5" H 10522 2332 50  0000 R CNN
F 1 "IN_OUT" H 10522 2423 50  0000 R CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x02_P2.54mm_Vertical" H 10550 2450 50  0001 C CNN
...
U 1 1 5DD12A85
P 10550 3050
F 0 "J6" H 10522 2932 50  0000 R CNN
F 1 "EFF_IN_OUT" H 10522 3023 50  0000 R CNN
...
U 1 1 5DD15BB3
P 9250 3100
F 0 "#PWR01" H 9250 2850 50  0001 C CNN
...
U 1 1 5DD48325
P 4750 1250
F 0 "U2" H 4750 1592 50  0000 C CNN
F 1 "AP2204K-5.0" H 4750 1501 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 4750 1575 50  0001 C CNN
F 3 "https://www.diodes.com/assets/Datasheets/AP2204.pdf" H 4750 1350 50  0001 C CNN
	1    4750 1250
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5DD59B41
P 5300 1500
F 0 "C2" H 5415 1546 50  0000 L CNN
F 1 "2.2uf" H 5415 1455 50  0000 L CNN
